 ...
 * 
 * This implementation should be used when the ISubjectSet interface is to be 
 * implemented. For the ISubject interface alone see SubjectObserverBaseClass
 * @author Qkitty
 * @param <T> - A data type that may be passed to the update method of an observer
 * Useful to pass details of the changes made.
 */
public class SubjectSetObserverBaseClass<T> extends SubjectSetBaseClass implements IObserver<T>{
